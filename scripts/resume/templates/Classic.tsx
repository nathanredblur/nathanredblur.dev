	...
	>
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.sidebar}>
				...
				<ContactLine icon={<PinIcon color={classicTheme.accent} />}>
					{resumeProfile.location}
				</ContactLine>
				<ContactLine icon={<GlobeIcon color={classicTheme.accent} />}>
					{resumeProfile.website}
				</ContactLine>
				<ContactLine icon={<MailIcon color={classicTheme.accent} />}>
					{resumeProfile.email}
				</ContactLine>
				<ContactLine icon={<LinkedInIcon color={classicTheme.accent} />}>
