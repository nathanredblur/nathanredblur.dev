...
export const projectsData: Project[] = [
	...
	},
	{
		...
		name: "AirTM",
		description:
			"I solved numerous issues and added new features to the platform.",
	...
	},
	{
		...
		description:
			"My team and I developed a dashboard showcasing advanced graphs and maps providing insights into the vacation rental market. We utilized React, Next.js, TypeScript, the Google Maps API, and Stripe.",
		tools: [
			"React",
			"Next JS",
			"Apollo GraphQL",
